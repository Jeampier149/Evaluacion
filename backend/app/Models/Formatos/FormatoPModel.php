...
class FormatoPModel extends Model
{
    use HasFactory;
     ...
     * @return array
     */
    public function listarFormatosP(stdClass $params): array
    {
        $smtp = $this->conexion->getPdo()->prepare(/** @lang SQL */ 'EXEC dbo.format_sp_lst_pg_formatoP ?,?,?,?,?');
    ...
    public function obtenerFormatosP(string $idPerfil): array
    {
    ...
    public function editarFormatosP(stdClass $params, $usuario, $perfil, $equipo): array
    {
    ...
    public function guardarFormatosP(stdClass $params, $usuario, $perfil, $equipo): array
    {
    ...
    public function anularFormatosP(string $id, string $motivo, $usuario, $perfil, $equipo): array
    {
    ...
    public function activarFormatosP(string $id, $usuario, $perfil, $equipo): array
    {
