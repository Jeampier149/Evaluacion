...
class FormatoCabModel extends Model
{
    use HasFactory;
     ...
     * @return array
     */
    public function listarFormatoCab(stdClass $params): array
    {
        $smtp = $this->conexion->getPdo()->prepare(/** @lang SQL */ 'EXEC dbo.format_sp_lst_pg_formatoCab ?');
    ...
    public function obtenerFormatoCab(string $idPerfil): array
    {
    ...
    public function editarFormatoCab(stdClass $params, $usuario, $perfil, $equipo): array
    {
    ...
    public function guardarFormatoCab(stdClass $params, $usuario, $perfil, $equipo): array
    {
    ...
    public function anularFormatoCab(string $id, string $motivo, $usuario, $perfil, $equipo): array
    {
    ...
    public function activarFormatoCab(string $id, $usuario, $perfil, $equipo): array
    {
