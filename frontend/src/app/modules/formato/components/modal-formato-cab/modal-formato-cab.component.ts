...
@Component({
  selector: 'app-modal-formato-cab',
  templateUrl: './modal-formato-cab.component.html',
  styleUrl: './modal-formato-cab.component.scss'
})
export class ModalFormatoCabComponent {
